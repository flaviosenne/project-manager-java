...
public class SwaggerConfig {
    ...
    private final ResponseMessage m403= simpleMessage(401, "Não autorizado");
    ...
    public Docket forumApi(){
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.api.newe"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "API de cotação da NEWE",
                "Esta API é utilizada para o painel de cotação da NEWE desenvolvida pela IZagro",
                "Versão 1.0",
                "https://izagro.com.br/privacy.html",
                new Contact("NEWE",
                        "http://portal-hml.newecorretor.com.br",
                        "flaviosenne@123@gmail.com"),
                "Direitos reservados",
                "https://izagro.com.br/privacy.html",
